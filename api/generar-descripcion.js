...
Analiza las imágenes y devuelve ÚNICAMENTE un JSON válido sin markdown, sin explicaciones, sin texto adicional antes o después. El JSON debe tener exactamente estos campos:
{
  ...
  "descripcion_publica": "Genera una descripción de 2-3 oraciones para el catálogo de clientas. El tono debe ser aspiracional y sensorial — que la clienta pueda imaginar cómo se siente y cómo la hace ver la prenda. Menciona la marca y transmite que es una pieza premium a un precio accesible sin decirlo explícitamente. Evita tecnicismos y frases genéricas como 'perfecta para cualquier ocasión'. Escribe como si describieras una inversión personal, no solo una prenda de ropa. Máximo 3 oraciones."
}
